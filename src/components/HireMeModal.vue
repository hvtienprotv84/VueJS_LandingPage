				...
				<transition name="fade-up-down">
					...
					>
						...
						>
							...
							>
								<h5
									class="font-mono text-primary-dark dark:text-primary-light text-lg"
								>
									Bạn Đang Thắc Mắc Về Projects nào của mình!
								</h5>
								<button
							...
							<div class="modal-body p-5 w-full h-full">
								<form class="max-w-xl m-4 text-left">
									...
									<div class="mt-6 mb-4">
										<label
											class="block font-sans mb-2 text-lg text-primary-dark dark:text-primary-light"
											for="project"
											>Loại Project</label
										>
										<select
									...
									<div class="mt-7 pb-4 sm:pb-1">
										<Button
											title="Gửi Yêu Cầu"
											class="font-mono px-4 sm:px-6 py-2 sm:py-2.5 text-white bg-indigo-500 hover:bg-indigo-600 rounded-md focus:ring-1 focus:ring-indigo-900 duration-500"
											type="submit"
							...
							>
								<Button
									title="Đóng"
									class="font-mono mt-[-10px] mr-[5px] px-4 sm:px-6 py-2 bg-gray-600 text-primary-light hover:bg-ternary-dark dark:bg-gray-200 dark:text-secondary-dark dark:hover:bg-primary-light rounded-md focus:ring-1 focus:ring-indigo-900 duration-500"
									@click="showModal()"
